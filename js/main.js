$(document).ready(function () {
	...
	$("#save").click(function () {
		...
		html2canvas(div, { allowTaint: true, useCORS: true, scale: 1.25 }).then(function (canvas) {
			$("#canvas").html(canvas);
	...
	function resizeToFit(text, div) {
		...
		if (larger) {
			...
			textFit(div);
			text.css("font-size", "min(29px, 100%)");
		}
	}
});
